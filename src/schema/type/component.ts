...
export type ComponentSchema = ActionButtonComponent | CardComponent | Card2Component | Card3Component | Card4Component | ContainerComponent | EventButtonComponent | InputComponent;
